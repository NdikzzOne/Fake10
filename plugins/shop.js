...
//ichanzx
const Sbanteng = 150000
const Sharimau = 100000
const Sgajah = 70000
const Skambing = 100000
const Spanda = 50000
const Sbuaya = 100000
const Skerbau = 120000
const Ssapi = 180000
const Smonyet = 135000
const Sbhutan = 155000
const Sbabi = 70000
const Sayam = 120000
//ichanzx
                ...
                switch (_type) {
                   ...
                   case 'emas':
                    ...
                    case 'batu':
                        ...
                        } else conn.reply(m.chat, `Batu anda tidak cukup ${global.db.data.users[m.sender].banteng}`, m)
                        break
                    case 'limit':
                   ...
                   case 'banteng':
                        if (global.db.data.users[m.sender].banteng >= count * 1) {
                            ...
                            global.db.data.users[m.sender].banteng -= count * 1
                            conn.reply(m.chat, `Succes menjual ${count} Banteng dengan harga ${Sbanteng * count} money`.trim(), m)
                        } else conn.reply(m.chat, `Hewan Banteng kamu tidak cukup`.trim(), m)
                        break
                    case 'harimau':
                        if (global.db.data.users[m.sender].harimau >= count * 1) {
                            ...
                            conn.reply(m.chat, `Succes menjual ${count} harimau dengan harga ${Sharimau * count} money`.trim(), m)
                        } else conn.reply(m.chat, `Hewan Harimau kamu tidak cukup`.trim(), m)
                        break
                    case 'gajah':
                        if (global.db.data.users[m.sender].gajah >= count * 1) {
                            ...
                            conn.reply(m.chat, `Succes menjual ${count} Gajah dengan harga ${Sgajah * count} money`.trim(), m)
                        } else conn.reply(m.chat, `Hewan Gajah kamu tidak cukup`.trim(), m)
                        break
                        case 'kambing':
                        if (global.db.data.users[m.sender].kambing >= count * 1) {
                            ...
                            conn.reply(m.chat, `Succes menjual ${count} Kambing dengan harga ${Skambing * count} money`.trim(), m)
                        } else conn.reply(m.chat, `Hewan Kambing kamu tidak cukup`.trim(), m)
                        break
                        case 'panda':
                        if (global.db.data.users[m.sender].panda >= count * 1) {
                            ...
                            conn.reply(m.chat, `Succes menjual ${count} Panda dengan harga ${Spanda * count} money`.trim(), m)
                        } else conn.reply(m.chat, `Hewan Panda kamu tidak cukup`.trim(), m)
                        break
                        case 'buaya':
                        if (global.db.data.users[m.sender].buaya >= count * 1) {
                            global.db.data.users[m.sender].money += Sbuaya * count
                            global.db.data.users[m.sender].banteng -= count * 1
                            conn.reply(m.chat, `Succes menjual ${count} Buaya dengan harga ${Sbuaya * count} money`.trim(), m)
                        } else conn.reply(m.chat, `Hewan Buaya kamu tidak cukup`.trim(), m)
                        break
                        case 'kerbau':
                        if (global.db.data.users[m.sender].kerbau >= count * 1) {
                            ...
                            conn.reply(m.chat, `Succes menjual ${count} Kerbau dengan harga ${Skerbau * count} money`.trim(), m)
                        } else conn.reply(m.chat, `Hewan Kerbau kamu tidak cukup`.trim(), m)
                        break
                        case 'sapi':
                        if (global.db.data.users[m.sender].sapi >= count * 1) {
                            ...
                            conn.reply(m.chat, `Succes menjual ${count} Sapi dengan harga ${Ssapi * count} money`.trim(), m)
                        } else conn.reply(m.chat, `Hewan Sapi kamu tidak cukup`.trim(), m)
                        break
                        case 'monyet':
                        if (global.db.data.users[m.sender].monyet >= count * 1) {
                            ...
                            conn.reply(m.chat, `Succes menjual ${count} Monyet dengan harga ${Smonyet * count} money`.trim(), m)
                        } else conn.reply(m.chat, `Hewan Monyet kamu tidak cukup`.trim(), m)
                        break
                        case 'babihutan':
                        if (global.db.data.users[m.sender].babihutan >= count * 1) {
                            global.db.data.users[m.sender].money += Sbhutan * count
                            global.db.data.users[m.sender].babihutan -= count * 1
                            conn.reply(m.chat, `Succes menjual ${count} Babi Hutan dengan harga ${Sbhutan * count} money`.trim(), m)
                        } else conn.reply(m.chat, `Hewan Babi Hutan kamu tidak cukup`.trim(), m)
                        break
                        case 'babi':
                        if (global.db.data.users[m.sender].babi >= count * 1) {
                            ...
                            conn.reply(m.chat, `Succes menjual ${count} Babi dengan harga ${Sbabi * count} money`.trim(), m)
                        } else conn.reply(m.chat, `Hewan Babi kamu tidak cukup`.trim(), m)
                        break
                        case 'ayam':
                        if (global.db.data.users[m.sender].ayam >= count * 1) {
                            ...
                            conn.reply(m.chat, `Succes menjual ${count} ayam dengan harga ${Sayam * count} money`.trim(), m)
                        } else conn.reply(m.chat, `Hewan Ayam kamu tidak cukup`.trim(), m)
                        break
                    case 'diamond':
